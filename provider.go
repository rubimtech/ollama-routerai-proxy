...
func NewRouterAIProvider(baseUrl string, apiKey string) *RouterAIProvider {
...
func (o *RouterAIProvider) Chat(messages []openai.ChatCompletionMessage, modelName string, tools []openai.Tool, toolChoice interface{}) (openai.ChatCompletionResponse, error) {
...
func (o *RouterAIProvider) ChatStream(messages []openai.ChatCompletionMessage, modelName string, tools []openai.Tool, toolChoice interface{}) (*openai.ChatCompletionStream, error) {
	req := openai.ChatCompletionRequest{
		Model:      modelName,
		Messages:   messages,
		Stream:     true,
...
func (o *RouterAIProvider) GetModels() ([]Model, error) {
...
func (o *RouterAIProvider) GetModelDetails(modelName string) (map[string]interface{}, error) {
...
func (o *RouterAIProvider) GetFullModelName(alias string) (string, error) {
